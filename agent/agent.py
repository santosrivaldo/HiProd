...
# OpenCV (cv2) e mss para captura de frames de tela (redimensionar/comprimir)
try:
    import cv2
    if cv2 is None:
    ...
    while True:
        ...
        if ociosidade % 10 == 0:
            ...
            if usuario_monitorado_id is not None:
                ...
                safe_print(f"[LOG] Registro adicionado: {current_window_info['application']} - {current_window_info['page_title'] or 'N/A'}")
            else:
