...
from backend.drive_upload_queue import start_background_worker, start_midnight_worker
...
if __name__ == '__main__':
    try:
        ...
        # Drive: worker da fila (itens antigos) e job de madrugada (cache do dia -> Drive)
